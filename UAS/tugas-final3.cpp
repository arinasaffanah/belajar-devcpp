...
int main (){
	...
	gotoxy(1,35);cout<<"====================================================================================================================";
	int i = 1, jmlAnak[6];
	float masaKerja[6], sanksi[6],mkTabel[6], sanksiTabel[6];
	string jwb, nip[6], nama[6], status[6];
	string jabatan[6] = {"Direktur", "Direktur", "Direktur", "Direktur", "Direktur", "Direktur"};
	float bonus[6], tunjAnak[6], gajiBersih [6];
	float gaji[6] = {20000000, 20000000, 20000000, 20000000, 20000000, 20000000};
	...
	float ijk = 0.05,  ijkk = 0.00174, ijkm = 0.003, ijht = 0.057, ijp = 0.03;
	float jk[6], jkk[6], jkm[6], jht[6], jp[6];
	...
	do {
		...
		gotoxy(103,24+i);cout << gajiBersihString[i];
//		gotoxy(1,2);cout<<"Masukkan NIP : ";
//		cin >> jwb;
//		
