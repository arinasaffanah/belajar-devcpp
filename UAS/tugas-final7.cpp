...
void gotoxy(int x, int y)
{
	...
	int i = 1, j=1, k = 1, jmlAnak[15];
	double masaKerja[15], sanksi[15],mkTabel[15], sanksiTabel[15];
	string jwb, nip[15], nama[15], status[15];
...
void total(){
	...
	for (int l = 0; l < 15 ; l++){
		...
		gotoxy(1,75);cout << "Halaman \t\t: 001 s/d 003";
		gotoxy(1,76);cout << "Total Gaji \t\t: " << setw (11) <<totGaji;
		gotoxy(1,77);cout << "Total Bonus \t: " << setw (11) << totBonus;
