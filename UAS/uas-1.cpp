...
void input1(){
	for (int i = 0; i < 5; i++){
		...
		gotoxy(90,12);cout<<sizeof(bonusAkhir[i])/sizeof(totSize[0]);
		gotoxy(90,13);cout<<sizeof(bonusAkhir[i])/sizeof(totSize[1]);
		gotoxy(90,14);cout<<sizeof(bonusAkhir[i])/sizeof(totSize[2]);
		gotoxy(90,15);cout<<sizeof(bonusAkhir[i])/sizeof(totSize[3]);
		gotoxy(90,16);cout<<sizeof(bonusAkhir[i])/sizeof(totSize[4]);
