...
void input1(){
	for (int i = 0; i < 5; i++){
		...
		//gotoxy(90,14);cout<<sizeof(bonusAkhir[i])/sizeof(totSize[0])<< " orang";
...
//		gotoxy(90,17);cout<<sizeof(bonusAkhir[i])/sizeof(totSize[4])<< " orang";
	...
	int length5 = sizeof(bonusAkhir)/sizeof(totSize[4]);
		...
		gotoxy(90,13);cout<<length<< " orang";
...
void total(){
	for(int i=0; i<15 ; i++){
		...
		gotoxy(1,60);cout<<"Jumlah seluruh karyawan yang mendapat Bonus Akhir thn `Singapura & Malaysia` \t\t: ";
		gotoxy(1,61);cout<<"Jumlah seluruh karyawan yang mendapat Bonus Akhir thn `Malaysia WakaTobi & Raja Ampat` :";
		gotoxy(1,62);cout<<"Jumlah seluruh karyawan yang mendapat Bonus Akhir thn `Lembah Arraw & Pulau Mandeh` \t:";
		gotoxy(1,63);cout<<"Jumlah seluruh karyawan yang mendapat Bonus Akhir thn `Bali, PulauDewata` \t\t:";
		gotoxy(1,64);cout<<"Jumlah seluruh karyawan yang mendapat Bonus Akhir thn `PutriDuyung Park Ancol` \t: ";
	
//		gotoxy(90,60);cout<<sizeof(totSize[0])/sizeof(bonusAkhir[i])<< " orang";
//		gotoxy(90,61);cout<<sizeof(bonusAkhir2[i])/sizeof(totSize[1])<< " orang";
